...
def read_system_prompt():
    ...
    parser = argparse.ArgumentParser(description='Lee el mensaje inicial desde un archivo.')
    parser.add_argument('--perso', type=str, help='Nombre del archivo de sistema de inicio')
