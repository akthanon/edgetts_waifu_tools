...
def listen_to_voice():
    ...
    while running_repl:
        ...
        try:
            ...
            if args.perso in text.lower():
                # Extraer el texto después de la palabra clave
                keyword_index = text.lower().index(args.perso)
                # Añadir 5 para saltar la palabra "cali" y el espacio después de ella
                command = text[keyword_index + 5:].strip()
